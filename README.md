...
`mlepysak` stands for **MLE Python Swiss-Army-Knife**, a collection of `python` scripts for any **Devops** / **Sysadmin** purposes.
...
1. **From source**:
   ...
   ```bash
   git clone https://github.com/cosmoid/mlepysak.git
   cd mlepysak
   pip install -e .
   ```
...
Process SQL scripts, run queries and store results in CSV format and upload them to S3.
